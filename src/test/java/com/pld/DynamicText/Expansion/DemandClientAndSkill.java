...
public class DemandClientAndSkill{
	...
	public void verifyDemandClientAndSkillColor()
	{
		...
		String response=responsemethod("http://bldbz173018.cloud.dst.ibm.com:9080/api/pldDemandClientSkillColors");
	...
	public void verifyDemandClientAndSkill()
	{
		...
		String response=responsemethod("http://bldbz173018.cloud.dst.ibm.com:9080/api/pldDemandClientSKill");
	...
	{
		String response=responsemethod("http://bldbz173018.cloud.dst.ibm.com:9080/api/pldDemandOpPosTablefilters");
	...
	public void verifyOpenPositionChartdata()
	{
		...
		String response = responsemethod("http://bldbz173018.cloud.dst.ibm.com:9080/api/pldDemandTrend");
		JSONObject jsonobj = new JSONObject(response);
	...
	public void verifyOpenPositiontable()
	{
		...
		String response=responsemethod("http://bldbz173018.cloud.dst.ibm.com:9080/api/pldDemandOpPosDetails");
		JSONObject jsonobj = new JSONObject(response);
