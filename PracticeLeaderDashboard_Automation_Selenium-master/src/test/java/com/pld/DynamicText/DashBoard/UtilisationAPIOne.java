...
public class UtilisationAPIOne extends PldTestBase{
	...
	@Test(priority=1)
	public void verifyUtilizationQTDGraph() throws Exception
	{  
		...
		for(int i=0;i<sheetData.size();i++)
		{
         ...
         /* if(cellData.size()==1)
           ...
           dataurl =prop.getProperty("Util_QTDGraph")+str.replaceAll(",", prop.getProperty("labortype")); 
